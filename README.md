...
The xxx API PHP Client enables you to work with the Fulfillment Shopify Service.
...
~~~~ bash
# Example
composer require datenkraft/bb-fulfillment-shopify-service-php-client "~1.2.0"
~~~~
...
The library can be used to communicate with the Fulfillment Shopify Service Resource Server.
