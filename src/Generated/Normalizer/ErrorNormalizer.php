...
class ErrorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Datenkraft\Backbone\Client\FulfillmentShopifyService\Generated\Model\Error::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Datenkraft\Backbone\Client\FulfillmentShopifyService\Generated\Model\Error::class;
    }
    ...
    {
        return [\Datenkraft\Backbone\Client\FulfillmentShopifyService\Generated\Model\Error::class => false];
    }
}