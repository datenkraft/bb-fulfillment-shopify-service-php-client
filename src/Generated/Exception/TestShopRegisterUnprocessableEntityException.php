...
class TestShopRegisterUnprocessableEntityException extends UnprocessableEntityException
{
    /**
...
- TEST_SHOP_REGISTRATION_FAILED: Registration of the test shop failed.');
