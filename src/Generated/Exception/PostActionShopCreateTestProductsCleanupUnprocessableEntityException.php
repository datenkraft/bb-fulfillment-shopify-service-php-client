...
class PostActionShopCreateTestProductsCleanupUnprocessableEntityException extends UnprocessableEntityException
{
    /**
...
- CREATE_TEST_PRODUCTS_ALREADY_CLEANED_UP: Test products are already cleaned up.');
